...
subroutine initialize_model_parameters(model_parameters,processor,num_of_procs)
   ...
   model_parameters%num_predictions = 1!40
   model_parameters%trial_name = '6000_20_20_20_sigma0.5_beta_res0.001_beta_model_1.0_prior_0.0_overlap1_vertlevel_1_precip_epsilon0.001_ohtc_multiple_leakage_test_proper_leaks_'!2kbias_10_year_then_platue_speedy_atmo_only' !14d_0.9rho_10noise_beta0.001_20years'  
   ...
   model_parameters%trial_name_extra_end = '70yr_'!'climo_2kbias_10_year_then_platue_speedy_bc_atmo_no_ice_2k_sst_mean_20std_increase_'
   ...
   model_parameters%timestep_slab = 24*7!*14!*2!*7
