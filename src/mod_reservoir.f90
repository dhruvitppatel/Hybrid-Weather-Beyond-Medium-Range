...
subroutine initialize_model_parameters(model_parameters,processor,num_of_procs)
   ...
   model_parameters%trial_name = '6000_20_20_20_sigma0.5_beta_res0.001_beta_model_1.0_prior_0.0_overlap1_vertlevel_1_precip_epsilon0.001_ohtc_test_'!2kbias_10_year_then_platue_speedy_atmo_only' !14d_0.9rho_10noise_beta0.001_20years'  
   ...
   model_parameters%synclength = 24*14*2*12!*4 + 3*24!24*14*2 !+ 180*24
